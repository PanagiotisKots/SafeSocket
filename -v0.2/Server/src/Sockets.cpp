...
int ChoiceOne(){
	...
	*/
	...
	Server_Listen(port, time_out, cString);
		...
		cout<<"Inned to fix this to be able to modify and also have auto get ip, auto add port(4040) no encryption and allow user to change from settings";
		cout<<endl<<"Gonna need file saving and reading from there i think";
